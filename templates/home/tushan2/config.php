    ...
    <div class="layui-form-item">
     <label class="layui-form-label">背景图</label>
      <div class="layui-input-block">
       <input type="text" name="background" placeholder="./templates/home/tushan2/static/bg.webp" autocomplete="off" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
     <label class="layui-form-label">搜索引擎</label>
      <div class="layui-input-inline">
       <select lay-verify="required" name="searchEngine">
        <option value="off">关闭</option>
        <option value="on">开启</option>
       </select>
      </div>
     <div class="layui-form-mid layui-word-aux">是否显示搜索引擎框</div>
    </div>
